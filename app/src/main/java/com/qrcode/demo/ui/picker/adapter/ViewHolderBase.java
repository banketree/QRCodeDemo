 ...
 * html</a>
 * <p/>
 * Using A View Holder in ListView getView() method is a good practice in using
 * ListView;
 * <p/>
 * This class encapsulate the base operate of a View Holder: createView /
 * showData
 * 
 * @param <ItemDataType>
...
public abstract class ViewHolderBase<ItemDataType> {
	...
	/**
	 * create a view from resource Xml file, and hold the view that may be used
	 * in displaying data.
	 */
	...
	/**
	 * Check if the View Holder is still display the same data after back to
	 * screen.
	 * <p/>
