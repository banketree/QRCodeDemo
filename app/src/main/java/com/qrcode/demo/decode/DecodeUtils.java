...
public class DecodeUtils {
	...
	public String decodeWithZxing(byte[] data, int width, int height, Rect crop) {
		...
		PlanarYUVLuminanceSource source = new PlanarYUVLuminanceSource(data,
				width, height, crop.left, crop.top, crop.width(),
				crop.height(), false);
	...
	public String decodeWithZbar(Bitmap bitmap) {
		try {
			...
			return decodeWithZbar(TImageUtils.zoomImage(bitmap, 300, 300));
		}
	...
	public String decodeWithZxing(Bitmap bitmap) {
		...
		try {
			...
			return decodeWithZxing(TImageUtils.zoomImage(bitmap, 300, 300));
		}
	}
