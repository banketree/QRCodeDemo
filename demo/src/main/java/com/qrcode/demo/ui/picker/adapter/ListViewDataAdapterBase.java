...
package com.qrcode.demo.ui.picker.adapter;
...
public abstract class ListViewDataAdapterBase<ItemDataType> extends BaseAdapter {
	...
	public ListViewDataAdapterBase(final Object enclosingInstance,
			final Class<?> cls) {
	 ...
	 *            The view holder creator will create a View Holder that extends
	 *            {@link ViewHolderBase}
	 */
	public ListViewDataAdapterBase(
			ViewHolderCreator<ItemDataType> viewHolderCreator) {
		mViewHolderCreator = viewHolderCreator;
	}

	public void setViewHolderCreator(
			ViewHolderCreator<ItemDataType> viewHolderCreator) {
		mViewHolderCreator = viewHolderCreator;
	}

	public void setViewHolderClass(final Object enclosingInstance,
			final Class<?> cls, final Object... args) {
		mLazyCreator = LazyViewHolderCreator.create(enclosingInstance, cls,
				args);
	}
